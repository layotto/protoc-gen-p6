// The code below is copied from https://github.com/protocolbuffers/protobuf-go
...
// GenerateStructFile generates the contents of a .struct.go file.
func GenerateStructFile(gen *protogen.Plugin, file *protogen.File, filename string) *protogen.GeneratedFile {
...
func genImport(gen *protogen.Plugin, g *protogen.GeneratedFile, f *fileInfo, imp protoreflect.FileImport) {
	...
	impGen := GenerateStructFile(gen, impFile, "")
	impGen.Skip()
